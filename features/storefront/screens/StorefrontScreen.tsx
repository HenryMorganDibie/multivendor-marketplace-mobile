...
import { ShoppingCart, X, Clock, MapPin, ExternalLink, Globe, ChevronRight, FileText, Package, AlertCircle } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      <StorefrontHeader
        ...
        onToggleSearch={() => vm.setShowSearch(!vm.showSearch)}
      ...
      <StorefrontCatalog
        ...
        storefrontSections={vm.storefrontSections}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalGlassContainer}>
            ...
            <View style={styles.modalHeader}>
              <TouchableOpacity
                onPress={() => vm.setShowVendorDetails(false)}
              ...
              {vendor.area ? (
                <View style={styles.modalCityRow}>
                  ...
                  <Text style={styles.modalAreaText}>{vendor.area}</Text>
                </View>
              ) : null}
                ...
                {vendor.policy && vendor.policy.trim().length > 0 && (
                  <>
                    ...
                    >
                      ...
                      <Text style={styles.modalActionRowText}>Vendor Business Policy</Text>
