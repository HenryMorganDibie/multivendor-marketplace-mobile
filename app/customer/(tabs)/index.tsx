...
export default function CustomerHomeScreen() {
  ...
  const { regionName, countryName, city, hasCompletedInitialLocationSetup, isLoading: locationLoading } = useUserLocation();
          ...
          <View style={styles.locationRow}>
            ...
            >
              <Text style={styles.locationText}>
                {regionName && countryName ? `${city ? `${city}, ` : ''}${regionName}, ${countryName}` : 'Select location'}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
