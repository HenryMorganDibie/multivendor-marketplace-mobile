...
export default function LoginScreen() {
  ...
  const handleUseEmailVerification = () => {
    const trimmedEmail = email.trim();
    setEmailError('');
    setPasswordError('');
    setAuthError('');
    ...
    console.log('[AUTH FLOW] Using email verification instead');
          ...
          <View style={styles.content}>
            ...
            <View style={styles.form}>
              ...
              <TouchableOpacity
                ...
                onPress={handleUseEmailVerification}
                activeOpacity={0.7}
                disabled={isLoading}
              >
                <Text style={styles.emailVerificationText}>Use email verification instead</Text>
              </TouchableOpacity>
            </View>
