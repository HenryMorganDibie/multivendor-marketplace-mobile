...
import { ChevronLeft, ChevronRight, Camera, Lock, Info } from 'lucide-react-native';
      ...
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        <View style={styles.header}>
          ...
          <TouchableOpacity
            ...
            testID="profile-save-header"
          >
            <Text style={[styles.headerSaveText, (!isFormValid || isSaving) && styles.headerSaveTextDisabled]}>
