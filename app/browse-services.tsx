...
export default function BrowseServicesScreen() {
  ...
  const { data: vendors, isLoading, isError, refetch } = useVendorsByCategory('Safe Verified Services', countryCode || undefined, regionName || undefined);
    ...
    <View style={styles.container}>
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        ...
        <ListStateView
          ...
          emptyIcon={<Briefcase size={36} color={Colors.textMuted} strokeWidth={1.5} />}
          emptyTitle="No service providers yet"
          emptyDescription="Verified service providers will appear here once available in your region."
