...
export default function RecordExternalOrderScreen() {
  ...
  const unsavedChanges = useUnsavedChanges(
    { customerName, orderSource, items, fulfillmentDateTime, address, deliveryNote, notes, screenshots, paymentStatus },
    true
  );
      ...
      <SafeAreaView edges={['bottom']} style={styles.safeArea}>
        ...
        >
          ...
          >
            ...
            {/* SECTION 5: SCREENSHOTS (Pro/Pro+ only) */}
            {canUseScreenshots && (
              <View style={styles.section}>
          ...
          <View style={styles.bottomBar}>
            ...
            >
              <Text style={styles.createButtonText}>
                {items.length > 0
                  ? `Create Order  ${formatPriceWithCommas(total, vendorCurrency)}`
                  : 'Create Order'}
              </Text>
            </TouchableOpacity>
          </View>
