...
const styles = StyleSheet.create({
  ...
  itemCard: { backgroundColor: Colors.white, paddingVertical: 12, paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: Colors.borderSoft },
  itemHeader: { flexDirection: 'row' as const, alignItems: 'flex-start' as const, gap: 12 },
  itemImage: { width: 52, height: 52, borderRadius: 8, backgroundColor: Colors.border },
  itemInfo: { flex: 1 },
  itemNameRow: { flexDirection: 'row' as const, alignItems: 'flex-start' as const, gap: 8, marginBottom: 4 },
  itemQuantity: { fontSize: 14, fontWeight: '500' as const, color: Colors.textMuted },
  ...
  summaryRowTotal: {
    marginTop: 6, paddingTop: 14, borderTopWidth: 1, borderTopColor: Colors.border, marginBottom: 0,
  },
  ...
  declineButton: {
    ...
    borderRadius: 12, gap: 6, borderWidth: 1, borderColor: Colors.border,
  },
  declineButtonText: { fontSize: 17, fontWeight: '600' as const, color: Colors.error },
  acceptButton: {
    ...
    paddingVertical: 16, borderRadius: 12, gap: 6, minHeight: 52,
  },
  acceptButtonText: { fontSize: 17, fontWeight: '600' as const, color: Colors.white },
  ...
  bottomOutlineButton: {
    ...
    paddingVertical: 14, borderRadius: 12, minHeight: 48,
  ...
  actionButton: {
    flex: 1, flexDirection: 'row' as const, alignItems: 'center' as const,
    justifyContent: 'center' as const, backgroundColor: Colors.primary,
    paddingVertical: 16, borderRadius: 12, gap: 8, minHeight: 52,
  },
  actionButtonText: { fontSize: 17, fontWeight: '600' as const, color: Colors.white },
  cancelButton: {
    flex: 1, alignItems: 'center' as const, justifyContent: 'center' as const,
  ...
  eventInput: {
    backgroundColor: Colors.border, borderRadius: 10, padding: 14, fontSize: 15,
    color: Colors.text, minHeight: 80, textAlignVertical: 'top' as const,
  },
