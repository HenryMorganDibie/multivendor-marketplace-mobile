...
import { ChevronLeft, Send, Plus, ArrowUp, FileText, Package, MessageSquare, MapPin, MoreVertical, Info } from 'lucide-react-native';
          ...
          actions={((): ChatActionItem[] => [
            {
              ...
              onPress: () => console.log('[VENDOR PRE-ORDER CHAT] View customer profile'),
            },
            {
              id: 'search-chat',
              label: 'Search in chat',
              onPress: () => console.log('[VENDOR PRE-ORDER CHAT] Search in chat'),
            },
            {
              id: 'help',
              label: 'Help & safety',
            ...
            },
            {
              ...
              onPress: () => console.log('[VENDOR PRE-ORDER CHAT] Report customer'),
            },
            {
              id: 'block',
              ...
              onPress: () => {
                if (!preOrderChat?.id) return;
                blockUser({
                  id: preOrderChat.customerId,
                  name: customerName,
                  role: 'customer',
                  chatId: preOrderChat.id,
