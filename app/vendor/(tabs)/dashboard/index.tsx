      ...
      {!isPro ? (
        ...
        >
          ...
          <View style={insightStyles.lockedTextWrap}>
            <Text style={insightStyles.lockedTitle}>Growth Insights</Text>
            <Text style={insightStyles.lockedMessage}>
              Upgrade to Pro to unlock growth insights for your business.
            </Text>
          </View>
          <TouchableOpacity
          ...
          >
            <View style={insightStyles.growthInsightsLeft}>
              ...
              <View style={insightStyles.growthTextWrap}>
                <Text style={insightStyles.growthTitle}>Growth Insights</Text>
                <Text style={insightStyles.growthSubtitle}>Orders by source, customers & more</Text>
              </View>
            </View>
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.perfRow}>
          ...
          <View style={styles.perfCard}>
            <View style={styles.perfLabelWrap}>
              <Text style={styles.perfLabel} numberOfLines={2}>Orders</Text>
            </View>
          ...
          <View style={styles.perfCard}>
            <View style={styles.perfLabelWrap}>
              <Text style={styles.perfLabel} numberOfLines={2}>{"Storefront\nVisits"}</Text>
            </View>
                  ...
                  <View key={order.id}>
                    ...
                    >
                      ...
                      <View style={styles.listRowLeft}>
                        ...
                        <Text style={styles.listRowCustomer}>{order.customerName || 'Customer'}</Text>
                      </View>
                      <View style={styles.listRowRight}>
                        <Text style={styles.listRowMeta}>
                          {order.items.reduce((sum, i) => sum + i.quantity, 0)} items • {formatPriceWithCommas(order.total, (mockVendor.currency as Currency) || getCurrencyFromCountryCode(mockVendor.countryCode))}
                        </Text>
                        <ChevronIcon />
                      </View>
                    </TouchableOpacity>
