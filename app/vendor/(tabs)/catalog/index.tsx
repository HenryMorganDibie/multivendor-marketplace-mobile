...
export default function VendorCatalogScreen() {
  ...
  const sections = useMemo(() => {
    ...
    const sorted = [...categories]
      .filter((cat) => {
        ...
        if (q) {
          return catItems.some((i) => i.name.toLowerCase().includes(q));
        }
  ...
  }, [categories, getItemsByCategory, searchQuery, activeTab]);
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        >
          <SafeAreaView style={styles.addCategoryModal} edges={['top', 'bottom']}>
            <View style={styles.addCategoryHeader}>
              ...
              <TouchableOpacity onPress={handleSaveCategory} disabled={!categoryName.trim()}>
                <Text style={[styles.addCategorySaveText, !categoryName.trim() && styles.addCategorySaveTextDisabled]}>
                  Save
                </Text>
              </TouchableOpacity>
            </View>
            <View style={styles.addCategoryContent}>
              <View style={styles.addCategoryInputSection}>
...
const styles = StyleSheet.create({
  ...
  addCategorySaveTextDisabled: {
    color: Colors.textMuted,
  },
  addCategoryContent: {
    padding: 16,
  },
  addCategoryInputSection: {
    backgroundColor: Colors.surface,
    borderRadius: 12,
    padding: 16,
  },
