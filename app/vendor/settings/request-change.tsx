...
const fields: FieldOption[] = [
  { key: 'businessName', label: 'Business Name', currentValue: 'Sanste Catering' },
  { key: 'businessCategory', label: 'Business Category', currentValue: 'Food & Catering' },
  { key: 'businessArea', label: 'Business Area', currentValue: 'Lagos, Lekki' },
  { key: 'contactEmail', label: 'Contact Email', currentValue: 'sanste@example.com' },
  { key: 'phoneNumber', label: 'Phone Number', currentValue: '+234 ••• ••• 5678' },
];
...
export default function RequestChangeScreen() {
  ...
  const isFieldValid = (key: FieldKey): boolean => {
    ...
    if (!state.newValue.trim()) return false;
  ...
  if (step === 1) {
    return (
      <View style={styles.container}>
        <Stack.Screen
          options={{
            title: 'Request Account Detail Change',
        ...
        <SafeAreaView edges={['bottom']} style={styles.safeArea}>
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            <Text style={styles.notice}>
              All requests require verification and admin approval.
            </Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <LaektivaModal
        ...
        message="This request will be reviewed by the platform. Changes will not apply until approved."
        primaryButton={{
