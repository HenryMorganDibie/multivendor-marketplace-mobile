...
import { ChevronLeft, Send, Sparkles, MessageCircle, MoreVertical, Plus } from 'lucide-react-native';
import { ChatActionMenu, ChatActionItem } from '@/components/ChatActionMenu';
import { useRouter, Stack, useLocalSearchParams } from 'expo-router';
import { createRorkTool, useRorkAgent } from '@rork-ai/toolkit-sdk';
import { z } from 'zod';
import { mockVendors, mockMenuItems } from '@/mocks/vendorData';
import { formatPrice } from '@/utils/formatPrice';

const AI_SESSION_TIMEOUT_MS = 30 * 60 * 1000;

const AI_BUBBLE_BG = 'rgba(255, 140, 66, 0.07)';
const AI_BUBBLE_BORDER = 'rgba(255, 140, 66, 0.18)';
...
Be friendly, clear, and concise. Adapt to the vendor's business type.`;
  ...
  const handleViewItem = (itemId: string, vid: string) => {
    console.log('[AI CHAT] Navigating to item:', itemId, 'vendor:', vid);
    router.push({
  ...
  const renderItemCard = (itemId: string, vid: string) => {
    ...
    return (
      <View key={item.id} style={styles.itemCard}>
        ...
        <TouchableOpacity
          ...
          onPress={() => handleViewItem(item.id, vid)}
          activeOpacity={0.7}
        >
      ...
      >
        ...
        <View
          style={[
            ...
            isUser && styles.userContentWrapper,
          ]}
        >
  ...
  return (
    <>
      ...
      >
        ...
        <View style={[styles.contentWrapper, { backgroundColor: '#F7F3EF' }]}>
          <ScrollView
            ref={scrollViewRef}
        ...
        <SafeAreaView edges={['bottom']} style={styles.inputSafeArea}>
          ...
          <View style={styles.inputContainer}>
            <TouchableOpacity style={styles.inputPlusButton} activeOpacity={0.7}>
