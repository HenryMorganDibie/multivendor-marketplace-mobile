...
import { ChevronLeft, Send, Package, Truck, ChevronRight, MoreVertical, Info } from 'lucide-react-native';
            ...
            <View style={styles.incomingAvatarSlot}>
              {isLastInGroup ? (
                resolvedVendor.logoImage ? (
                  <Image source={{ uri: resolvedVendor.logoImage }} style={styles.incomingAvatar} contentFit="cover" />
                ) : (
                  <View style={[styles.incomingAvatar, { backgroundColor: getStableColor(vendorName) }]}>
                    <Text style={styles.incomingAvatarText}>{getInitials(vendorName)}</Text>
                  </View>
                )
              ) : null}
            </View>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            ...
            <Text style={styles.headerSubtitle} numberOfLines={1}>
              {resolvedVendor.slug ? resolvedVendor.slug.toUpperCase() : headerSubtitle}
            </Text>
          </View>
          <TouchableOpacity
      ...
      <ChatActionMenu
        ...
        actions={((): ChatActionItem[] => [
          ...
          },
          {
            ...
            onPress: () => console.log('[PRE-ORDER CHAT] Search in chat'),
          },
          {
            id: 'help',
            label: 'Help with this chat',
          ...
          },
          {
            ...
            requireConfirm: {
              title: 'Block vendor',
              message: 'This will archive the chat and prevent further messages.',
              confirmLabel: 'Block',
            },
            onPress: () => blockUser({
              id: `vendor-${vendorId}`,
