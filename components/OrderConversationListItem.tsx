...
const getStableColor = (name: string): string => {
  const colors = ['#E8845C', Colors.success, '#5B9BD5', '#E89B6C', '#7BC8B8', '#F0C75E', '#A78BCA', '#6AADDB'];
  let hash = 0;
...
export function CircularAvatar({ name }: { name: string; children?: React.ReactNode }) {
  const initials = getInitials(name);
  const backgroundColor = getStableColor(name);
