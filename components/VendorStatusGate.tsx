...
const BLOCK_CONFIG: Record<BlockType, {
  ...
  WAITLISTED: {
    ...
    title: 'This store is not yet active on theplatform.',
  ...
  SUSPENDED: {
    ...
    message: 'This vendor is currently unavailable on theplatform.\nPlease contact support if you have an active order.',
    accentColor: '#DC2626',
  },
  DEACTIVATED: {
    Icon: Ban,
    ...
    title: 'This store is no longer available on theplatform.',
    message: 'This vendor has been removed from theplatform.\nPlease contact support if you have an active order.',
    accentColor: '#6B7280',
  },
};
