 ...
 * `'ORDER_CHAT'`) are still emitted by some upstream code paths and persisted
 * mock fixtures elsewhere — funnel them through {@link normalizeChatType} at
 * the boundary instead of branching on the raw string.
 */
export type ChatType = 'pre_order_inquiry' | 'order_chat';
...
export const mockChats: Chat[] = [
  ...
  },
  {
    ...
    createdAt: '2024-01-15T10:30:00Z',
    lastActivityAt: '2024-01-15T10:47:00Z',
    vendorCanReply: true,
  },
  {
    id: 'chat-v1-c3',
