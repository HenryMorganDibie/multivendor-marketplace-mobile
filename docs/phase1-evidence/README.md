...
| Link | Opens |
|---|---|
| Terms of Use | `https://example.com/terms-of-service` |
| Privacy Policy | `https://example.com/privacy-policy` |
| Vendor Agreement | `https://example.com/vendor-terms` |

Those routes exist and render in the multivendor-marketplace-platform (website/) repo. They currently show
