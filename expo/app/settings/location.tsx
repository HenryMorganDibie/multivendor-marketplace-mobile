...
import { ChevronLeft, ChevronRight, Globe, MapPin, Navigation, Check, AlertTriangle, ArrowLeft, Search } from 'lucide-react-native';
...
export default function LocationSettingsScreen() {
  ...
  const handleAreaPress = () => {
    router.push('/settings/area' as any);
  };
          ...
          <View style={styles.glassCard}>
            ...
            >
              <View style={styles.rowLeft}>
                ...
                <View>
                  <Text style={styles.rowLabel}>Region / State</Text>
            ...
            <TouchableOpacity
              style={[styles.settingsRow, !regionId && styles.settingsRowDisabled]}
            ...
            >
              <View style={styles.rowLeft}>
                ...
                <View>
                  ...
                  <Text style={styles.rowValue}>
                    {area || (regionId ? 'Not set' : 'Select a region first')}
                  </Text>
                </View>
              </View>
              <ChevronRight size={20} color={Colors.textSecondary} />
