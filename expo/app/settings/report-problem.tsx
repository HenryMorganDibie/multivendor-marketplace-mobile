...
export default function ReportProblemScreen() {
  ...
  // Files into the same real support-ticket system as Contact Support
  // (Settings -> Support), reusing createSupportTicket/sendChatMessage
  // rather than inventing a separate reports collection. Picked images are
  // still previewed here but not yet uploaded anywhere — the app has no
  // chat-attachment upload path built for any screen yet, so attaching
  // them for real is separate, unbuilt work, not a regression from before.
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!res.data.created) {
        // An open ticket already existed for this customer, so
