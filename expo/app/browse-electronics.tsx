...
export default function BrowseElectronicsScreen() {
  ...
  const { data: vendors, isLoading, isError, refetch } = useVendorsByCategory('Electronics Repair', countryCode || undefined, regionName || undefined);
    ...
    <View style={styles.container}>
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        ...
        <ListStateView
          ...
          emptyIcon={<Cpu size={36} color={Colors.textMuted} strokeWidth={1.5} />}
          emptyTitle="No electronics vendors"
          emptyDescription="Electronics repair vendors will appear here once available in your region."
