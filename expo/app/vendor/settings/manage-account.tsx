  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView edges={['top']} style={styles.headerSafe}>
        <EditScreenHeader title="Manage Account" onBack={() => router.back()} showSave={false} />
      </SafeAreaView>
      <SafeAreaView edges={['bottom']} style={styles.safeArea}>
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.protectionCard, isVerified ? styles.protectionCardVerified : styles.protectionCardOpen]}>
            <Text style={styles.protectionTitle}>
              {isVerified ? 'Account details are protected' : 'Complete verification to protect details'}
            </Text>
            <Text style={styles.protectionText}>
              {isVerified
                ? 'These details are protected. Submit a request to change them.'
                : 'Complete verification to lock and protect your account details.'}
            </Text>
            <Text style={styles.protectionMeta}>
              These details are protected. Changes require verification and admin approval.
            </Text>
          </View>
