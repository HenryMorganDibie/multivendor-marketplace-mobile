...
export default function VendorNotificationsScreen() {
  ...
  const { notifications, markAsRead, markAllAsRead } = useVendorNotifications();
      ...
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        <View style={styles.header}>
          <TouchableOpacity
            ...
            onPress={() => router.back()}
            activeOpacity={0.7}
            testID="vendor-notifications-back"
          >
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyDescription}>
              New orders, customer messages, verification updates, and support replies will appear here.
            </Text>
          </View>
        }
