...
export default function DeliveryResponsibilityScreen() {
  ...
  const handleContinue = () => {
    ...
    router.push('/vendor-verification-required' as any);
  };
        ...
        >
          <View style={styles.body}>
            ...
            >
              <View style={styles.iconInner}>
                <Truck size={36} color="#FF8C42" strokeWidth={1.8} />
              </View>
            </Animated.View>

            <Text style={styles.title}>Delivery is your responsibility</Text>
            <Text style={styles.subtitle}>
              If you offer delivery, you are responsible for coordinating it and confirming payment before dispatch.
            </Text>
            ...
            <View style={styles.checklistContainer}>
              <CheckItem
                ...
                label="I understand I manage delivery myself"
                testID="delivery-check-1"
              />
              <CheckItem
                checked={check2}
          ...
          <View style={styles.footer}>
            <TouchableOpacity
              ...
              activeOpacity={0.85}
              disabled={!allChecked}
              testID="delivery-responsibility-continue"
            >
              <Text
                style={[
                  styles.buttonText,
