...
import { useVendorsNearYou } from '@/data/hooks';
...
export default function VendorsNearYouScreen() {
  ...
  const { data: vendors, isLoading, isError, refetch } = useVendorsNearYou(countryCode || undefined, regionName || undefined, city || undefined);
