...
// TODO: LEGACY AUTH SCREEN — superseded by /register/customer.
// Kept in the codebase only for reference; no longer reachable from the main auth flow.
// Remove this file once the Firebase backend integration is confirmed.
