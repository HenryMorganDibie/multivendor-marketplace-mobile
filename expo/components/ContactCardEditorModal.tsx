...
import { Trash2, AlertCircle, Lock, ChevronLeft } from 'lucide-react-native';
import {
  validateLabel,
  validateName,
  validatePhone,
...
interface ContactCardEditorModalProps {
  visible: boolean;
  cardId?: string | null;
  onClose: () => void;
}
...
/**
 * Full-screen modal editor for creating or editing a contact card.
 * Designed to be presented on top of the in-chat Contact Card picker so that
 * dismissing it returns to the picker list (not the underlying chat).
 */
export function ContactCardEditorModal({
  visible,
  cardId,
  onClose,
}: ContactCardEditorModalProps) {
