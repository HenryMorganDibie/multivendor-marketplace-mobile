...
const BLOCK_CONFIG: Record<BlockType, {
  ...
  WAITLISTED: {
    ...
    title: 'This store is not yet active on Platform.',
  ...
  SUSPENDED: {
    ...
    message: 'This vendor is currently unavailable on Platform.\nPlease contact support if you have an active order.',
    accentColor: '#DC2626',
  },
  DEACTIVATED: {
    Icon: Ban,
    ...
    title: 'This store is no longer available on Platform.',
    message: 'This vendor has been removed from Platform.\nPlease contact support if you have an active order.',
    accentColor: '#6B7280',
  },
  FROZEN: {
    Icon: ShieldOff,
