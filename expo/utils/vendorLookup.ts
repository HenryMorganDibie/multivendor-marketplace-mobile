...
export function canAccessStorefront(
  ...
  switch (status) {
    ...
    case 'registered':
      ...
      return { allowed: false, readOnly: false, message: 'This store is not yet active on the platform.' };
    case 'suspended':
      return { allowed: false, readOnly: false, message: 'This store is temporarily unavailable.' };
    case 'deactivated':
      return { allowed: false, readOnly: false, message: 'This store is no longer available on the platform.' };
    default:
