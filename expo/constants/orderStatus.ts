...
export const CUSTOMER_STATUS_LABELS: Record<OrderStatus, string> = {
  ...
  awaiting_customer_update: 'Awaiting your update',
...
export const VENDOR_STATUS_LABELS: Record<OrderStatus, string> = {
  ...
  awaiting_customer_update: 'AWAITING UPDATE',
  completed:   'COMPLETED',
  rejected:    'REJECTED',
  cancelled:   'CANCELLED',
  expired:     'EXPIRED',
...
export const ORDER_STATUS_COLORS: Record<OrderStatus, StatusColorToken> = {
  ...
  awaiting_customer_update: { background: '#FFFBEB', text: '#D97706' },
